...
function createData( name, Order_Id,table_name) {
  return { name, Order_Id,table_name};
}
...
class AdminTable extends React.Component{
    ...
    intializeRows()
    {
      ...
      createData(item.order_name, item.order_id,item.table_name));
    ...
    render()
    {
        return (
            <div>
                   ...
                   <Typography level="body-sm" sx={{ textAlign: 'center',mt:'100px',fontWeight:'bolder' }}>
        ORDER TABLE
      </Typography>
